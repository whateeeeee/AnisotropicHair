...
void InitializeCustomSurfaceData(Varyings input,out CustomSurfacedata customSurfaceData)
{
    ...
    customSurfaceData.IML = SAMPLE_TEXTURE2D(_ILMMap,sampler_ILMMap,input.uv).rgb;
    customSurfaceData.metallic = lerp(saturate(metallic),0.9,customSurfaceData.IML.b);
}
